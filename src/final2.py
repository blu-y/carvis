...
class erp_planner():
    def __init__(self):
        ...
        self.path_name='/home/kau/catkin_ws/path/path_kau '
        self.velocity = 3
        ...
        while not rospy.is_shutdown():
            ...
            self.waypoint=self.global_path[j]
            print(self.waypoint)
