...
set(MSG_I_FLAGS "-Irrt_exploration:/home/kau/catkin_ws/src/rrt_exploration/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/kau/catkin_ws/src/rrt_exploration/msg/PointArray.msg" NAME_WE)
add_custom_target(_rrt_exploration_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rrt_exploration" "/home/kau/catkin_ws/src/rrt_exploration/msg/PointArray.msg" "geometry_msgs/Point"
)
...
_generate_msg_cpp(rrt_exploration
  "/home/kau/catkin_ws/src/rrt_exploration/msg/PointArray.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rrt_exploration)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2.7\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rrt_exploration\")")
  # install generated code
  install(
