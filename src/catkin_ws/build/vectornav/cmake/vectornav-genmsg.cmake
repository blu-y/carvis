...
set(MSG_I_FLAGS "-Ivectornav:/home/kau/catkin_ws/src/vectornav/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/kau/catkin_ws/src/vectornav/msg/Ins.msg" NAME_WE)
add_custom_target(_vectornav_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "vectornav" "/home/kau/catkin_ws/src/vectornav/msg/Ins.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(vectornav
  "/home/kau/catkin_ws/src/vectornav/msg/Ins.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/vectornav)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2.7\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/vectornav\")")
  # install generated code
  install(
