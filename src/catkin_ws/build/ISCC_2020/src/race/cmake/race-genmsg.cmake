...
set(MSG_I_FLAGS "-Irace:/home/kau/catkin_ws/src/ISCC_2020/src/race/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/kau/catkin_ws/src/ISCC_2020/src/race/msg/drive_values.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/kau/catkin_ws/src/ISCC_2020/src/race/msg/drive_values.msg" ""
)

get_filename_component(_filename "/home/kau/catkin_ws/src/ISCC_2020/src/race/msg/test.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/kau/catkin_ws/src/ISCC_2020/src/race/msg/test.msg" ""
)

get_filename_component(_filename "/home/kau/catkin_ws/src/ISCC_2020/src/race/msg/enc_values.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/kau/catkin_ws/src/ISCC_2020/src/race/msg/enc_values.msg" ""
)

get_filename_component(_filename "/home/kau/catkin_ws/src/ISCC_2020/src/race/msg/lane_info.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/kau/catkin_ws/src/ISCC_2020/src/race/msg/lane_info.msg" ""
)

get_filename_component(_filename "/home/kau/catkin_ws/src/ISCC_2020/src/race/msg/mode.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/kau/catkin_ws/src/ISCC_2020/src/race/msg/mode.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/race)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2.7\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/race\")")
  # install generated code
  install(
