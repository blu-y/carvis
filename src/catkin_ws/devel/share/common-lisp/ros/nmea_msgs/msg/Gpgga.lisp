...
(cl:defmethod cl:initialize-instance :after ((m <Gpgga>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Gpgga)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nmea_msgs-msg:<Gpgga> is deprecated: use nmea_msgs-msg:Gpgga instead.")))
...
(cl:defmethod lat-val ((m <Gpgga>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:lat-val is deprecated.  Use nmea_msgs-msg:lat instead.")
  (lat m))

(cl:ensure-generic-function 'lon-val :lambda-list '(m))
(cl:defmethod lon-val ((m <Gpgga>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:lon-val is deprecated.  Use nmea_msgs-msg:lon instead.")
  (lon m))

(cl:ensure-generic-function 'lat_dir-val :lambda-list '(m))
(cl:defmethod lat_dir-val ((m <Gpgga>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:lat_dir-val is deprecated.  Use nmea_msgs-msg:lat_dir instead.")
  (lat_dir m))

(cl:ensure-generic-function 'lon_dir-val :lambda-list '(m))
(cl:defmethod lon_dir-val ((m <Gpgga>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:lon_dir-val is deprecated.  Use nmea_msgs-msg:lon_dir instead.")
  (lon_dir m))

(cl:ensure-generic-function 'gps_qual-val :lambda-list '(m))
(cl:defmethod gps_qual-val ((m <Gpgga>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:gps_qual-val is deprecated.  Use nmea_msgs-msg:gps_qual instead.")
  (gps_qual m))

(cl:ensure-generic-function 'num_sats-val :lambda-list '(m))
(cl:defmethod num_sats-val ((m <Gpgga>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:num_sats-val is deprecated.  Use nmea_msgs-msg:num_sats instead.")
  (num_sats m))

(cl:ensure-generic-function 'hdop-val :lambda-list '(m))
(cl:defmethod hdop-val ((m <Gpgga>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:hdop-val is deprecated.  Use nmea_msgs-msg:hdop instead.")
  (hdop m))

(cl:ensure-generic-function 'alt-val :lambda-list '(m))
(cl:defmethod alt-val ((m <Gpgga>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:alt-val is deprecated.  Use nmea_msgs-msg:alt instead.")
  (alt m))

(cl:ensure-generic-function 'altitude_units-val :lambda-list '(m))
(cl:defmethod altitude_units-val ((m <Gpgga>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:altitude_units-val is deprecated.  Use nmea_msgs-msg:altitude_units instead.")
  (altitude_units m))

(cl:ensure-generic-function 'undulation-val :lambda-list '(m))
(cl:defmethod undulation-val ((m <Gpgga>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:undulation-val is deprecated.  Use nmea_msgs-msg:undulation instead.")
  (undulation m))

(cl:ensure-generic-function 'undulation_units-val :lambda-list '(m))
(cl:defmethod undulation_units-val ((m <Gpgga>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:undulation_units-val is deprecated.  Use nmea_msgs-msg:undulation_units instead.")
  (undulation_units m))

(cl:ensure-generic-function 'diff_age-val :lambda-list '(m))
(cl:defmethod diff_age-val ((m <Gpgga>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:diff_age-val is deprecated.  Use nmea_msgs-msg:diff_age instead.")
  (diff_age m))

(cl:ensure-generic-function 'station_id-val :lambda-list '(m))
(cl:defmethod station_id-val ((m <Gpgga>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:station_id-val is deprecated.  Use nmea_msgs-msg:station_id instead.")
  (station_id m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Gpgga>)))
  ...
  "8f51cb504898f39d8ad9f698f0b6f9cd")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Gpgga)))
  "Returns md5sum for a message object of type 'Gpgga"
  "8f51cb504898f39d8ad9f698f0b6f9cd")
