...
(cl:defclass <Gpgsv> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (satellites
    :reader satellites
    :initarg :satellites
    :type (cl:vector nmea_msgs-msg:GpgsvSatellite)
   :initform (cl:make-array 0 :element-type 'nmea_msgs-msg:GpgsvSatellite :initial-element (cl:make-instance 'nmea_msgs-msg:GpgsvSatellite))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Gpgsv>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Gpgsv)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nmea_msgs-msg:<Gpgsv> is deprecated: use nmea_msgs-msg:Gpgsv instead.")))
...
(cl:defmethod n_msgs-val ((m <Gpgsv>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:n_msgs-val is deprecated.  Use nmea_msgs-msg:n_msgs instead.")
  (n_msgs m))

(cl:ensure-generic-function 'msg_number-val :lambda-list '(m))
(cl:defmethod msg_number-val ((m <Gpgsv>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:msg_number-val is deprecated.  Use nmea_msgs-msg:msg_number instead.")
  (msg_number m))

(cl:ensure-generic-function 'n_satellites-val :lambda-list '(m))
(cl:defmethod n_satellites-val ((m <Gpgsv>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:n_satellites-val is deprecated.  Use nmea_msgs-msg:n_satellites instead.")
  (n_satellites m))

(cl:ensure-generic-function 'satellites-val :lambda-list '(m))
(cl:defmethod satellites-val ((m <Gpgsv>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:satellites-val is deprecated.  Use nmea_msgs-msg:satellites instead.")
  (satellites m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Gpgsv>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'satellites)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'nmea_msgs-msg:GpgsvSatellite))
