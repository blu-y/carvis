...
(cl:defmethod cl:initialize-instance :after ((m <Gpgsa>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Gpgsa)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nmea_msgs-msg:<Gpgsa> is deprecated: use nmea_msgs-msg:Gpgsa instead.")))
...
(cl:defmethod auto_manual_mode-val ((m <Gpgsa>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:auto_manual_mode-val is deprecated.  Use nmea_msgs-msg:auto_manual_mode instead.")
  (auto_manual_mode m))

(cl:ensure-generic-function 'fix_mode-val :lambda-list '(m))
(cl:defmethod fix_mode-val ((m <Gpgsa>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:fix_mode-val is deprecated.  Use nmea_msgs-msg:fix_mode instead.")
  (fix_mode m))

(cl:ensure-generic-function 'sv_ids-val :lambda-list '(m))
(cl:defmethod sv_ids-val ((m <Gpgsa>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:sv_ids-val is deprecated.  Use nmea_msgs-msg:sv_ids instead.")
  (sv_ids m))

(cl:ensure-generic-function 'pdop-val :lambda-list '(m))
(cl:defmethod pdop-val ((m <Gpgsa>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:pdop-val is deprecated.  Use nmea_msgs-msg:pdop instead.")
  (pdop m))
...
(cl:defmethod vdop-val ((m <Gpgsa>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nmea_msgs-msg:vdop-val is deprecated.  Use nmea_msgs-msg:vdop instead.")
  (vdop m))
