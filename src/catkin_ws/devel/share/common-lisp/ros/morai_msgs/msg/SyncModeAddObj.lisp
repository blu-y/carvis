...
;//! \htmlinclude SyncModeAddObj.msg.html

(cl:defclass <SyncModeAddObj> (roslisp-msg-protocol:ros-message)
  ((name
    :reader name
    :initarg :name
    :type cl:string
...
(cl:defclass SyncModeAddObj (<SyncModeAddObj>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <SyncModeAddObj>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'SyncModeAddObj)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name morai_msgs-msg:<SyncModeAddObj> is deprecated: use morai_msgs-msg:SyncModeAddObj instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <SyncModeAddObj>))
...
(cl:defmethod position-val ((m <SyncModeAddObj>))
...
(cl:defmethod heading-val ((m <SyncModeAddObj>))
...
(cl:defmethod frame-val ((m <SyncModeAddObj>))
  ...
  (frame m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SyncModeAddObj>) ostream)
  "Serializes a message object of type '<SyncModeAddObj>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SyncModeAddObj>) istream)
  "Deserializes a message object of type '<SyncModeAddObj>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SyncModeAddObj>)))
  "Returns string type for a message object of type '<SyncModeAddObj>"
  "morai_msgs/SyncModeAddObj")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SyncModeAddObj)))
  "Returns string type for a message object of type 'SyncModeAddObj"
  "morai_msgs/SyncModeAddObj")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SyncModeAddObj>)))
  "Returns md5sum for a message object of type '<SyncModeAddObj>"
  "6d5eb87e0fc34ed28764f286444e7f82")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SyncModeAddObj)))
  "Returns md5sum for a message object of type 'SyncModeAddObj"
  "6d5eb87e0fc34ed28764f286444e7f82")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SyncModeAddObj>)))
  "Returns full string definition for message of type '<SyncModeAddObj>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SyncModeAddObj)))
  "Returns full string definition for message of type 'SyncModeAddObj"
  (cl:format cl:nil "string name~%geometry_msgs/Vector3 position~%float64 heading~%uint64 frame~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SyncModeAddObj>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SyncModeAddObj>))
  "Converts a ROS message object to a list"
  (cl:list 'SyncModeAddObj
