...
class NavRELPOSNED9 {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('reserved3')) {
        ...
        this.reserved3 = new Array(4).fill(0);
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int8(obj.relPosHPLength, buffer, bufferOffset);
    ...
    if (obj.reserved3.length !== 4) {
      throw new Error('Unable to serialize array field reserved3 - length must be 4')
    }
    // Serialize message field [reserved3]
    bufferOffset = _arraySerializer.uint8(obj.reserved3, buffer, bufferOffset, 4);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new NavRELPOSNED9(null);
    ...
    data.relPosHPLength = _deserializer.int8(buffer, bufferOffset);
    ...
    data.reserved3 = _arrayDeserializer.uint8(buffer, bufferOffset, 4)
  ...
  static Resolve(msg) {
    ...
    const resolved = new NavRELPOSNED9(null);
    ...
    if (msg.reserved3 !== undefined) {
      ...
      resolved.reserved3 = new Array(4).fill(0)
    }
