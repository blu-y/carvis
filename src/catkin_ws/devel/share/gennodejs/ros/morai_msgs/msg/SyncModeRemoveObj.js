...
class SyncModeRemoveObj {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SyncModeRemoveObj(null);
  ...
  static datatype() {
    ...
    return 'morai_msgs/SyncModeRemoveObj';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SyncModeRemoveObj(null);
...
module.exports = SyncModeRemoveObj;
