...
struct MultiEgoSetting_
{
  ...
  _camera_index_type camera_index;
   ...
   typedef std::vector<int32_t, typename ContainerAllocator::template rebind<int32_t>::other >  _ego_index_type;
  _ego_index_type ego_index;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _global_position_x_type;
  _global_position_x_type global_position_x;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _global_position_y_type;
  _global_position_y_type global_position_y;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _global_position_z_type;
  _global_position_z_type global_position_z;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _global_roll_type;
  _global_roll_type global_roll;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _global_pitch_type;
  _global_pitch_type global_pitch;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _global_yaw_type;
  ...
  _velocity_type velocity;
   ...
   typedef std::vector<int8_t, typename ContainerAllocator::template rebind<int8_t>::other >  _gear_type;
  _gear_type gear;

   typedef std::vector<int8_t, typename ContainerAllocator::template rebind<int8_t>::other >  _ctrl_mode_type;
