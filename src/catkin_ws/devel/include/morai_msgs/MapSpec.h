...
struct MapSpec_
{
  ...
  _utm_offset_type utm_offset;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _ellipse_type;
...
struct Printer< ::morai_msgs::MapSpec_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::morai_msgs::MapSpec_<ContainerAllocator>& v)
  {
    ...
    s << indent << "ellipse: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.ellipse);
