...
struct CollisionData_
{
  ...
  _global_offset_z_type global_offset_z;
   ...
   typedef std::vector< ::morai_msgs::ObjectStatus_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::morai_msgs::ObjectStatus_<ContainerAllocator> >::other >  _collision_object_type;
