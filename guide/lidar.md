...
<img src="src/lidar1.2.4.png" width="600"/>
...
<img src="src/lidar2.2.2.png" width="900"/>
...
`adaptive_clustering.launch` 파일을 실행시키면 cluster되는 것을 확인할 수 있다. Cluster 정보는 `/adaptive_clustering/center` topic을 통해 cluster의 중심점의 좌표(LiDAR 좌표계 기준)를 확인할 수 있다.
...
<img src="src/lidar3.1.png" width="600"/>

## 4. LeGO-LOAM SLAM Algorithm

### 4.1 Usage & Result

LeGO-LOAM을 통해 LiDAR를 이용한 3D mapping이 가능하다.

```
$ roslaunch velodyne_pointcloud VLP16_points.launch &
$ roslaunch lego_loam run.launch # original + occupancy map
$ roslaunch lego_loam run_orig.launch # original map
```

<img src="src/lidar4.1.1.png" width="600"/>
<img src="src/lidar4.1.2.png" width="600"/>

장애물들의 좌표를 얻기 위해 LiDAR를 활용했는데 adaptive_clustering이 더 직접적인 솔루션을 제공했기 때문에 미션 수행에서는 LeGO-LOAM을 사용하지는 않았다.

**Reference:**

[velodyne_pointcloud](https://github.com/ros-drivers/velodyne/tree/master/velodyne_pointcloud)
